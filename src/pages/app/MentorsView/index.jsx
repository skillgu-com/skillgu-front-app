		...
		<AppLayout>
			...
			<section className='d-flex flex-wrap'>
				...
				<MentorCard
					...
					reviewsAmount={21}
					description={
						'Jestem doświadczonym ekspertem ds. marketingu cyfrowego z ogromnym doświadczeniem, którym mogę się z Tobą podzielić.\n' +
						'\n' +
				...
				<MentorCard
					...
					monthlyPrice={300}
					expectations={[
						'Szybka odpowiedź na pytania i wsparcie',
						'Regularne sesje mentoringowe',
