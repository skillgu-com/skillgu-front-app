...
const ScheduleForm = () => {
	...
	const submitHandler = (e) => {
		...
		const weekTimes = {
			timeMonday: getDayHours('timeMonday'),
			timeTuesday: getDayHours('timeTuesday'),
			timeWednesday: getDayHours('timeWednesday'),
			timeThursday: getDayHours('timeThursday'),
			timeFriday: getDayHours('timeFriday'),
			timeSaturday: getDayHours('timeSaturday'),
			timeSunday: getDayHours('timeSunday'),
		};
