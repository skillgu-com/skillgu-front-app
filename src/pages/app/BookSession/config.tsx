export const faqRows: {
    ...
    {
        id: "00",
        title: "Czy cena zawiera wszystkie opłaty?",
        description:
            "Tak, cena za sesję zawiera wszystkie opłaty, w tym podatek VAT. Podana kwota jest ostateczna i nie zostaną doliczone żadne dodatkowe koszty.",
    },
    {
        id: "01",
