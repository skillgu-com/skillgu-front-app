...
import ScheduleCard, {ScheduleCardProps} from "src/components/Cards/ScheduleCard/ScheduleCard";
        ...
        (id: string, arrayType: "schedules" | "sessions") => {
            if (arrayType === "schedules") {
                ...
                const assignedSession =
                    schedules.find((schedule) => schedule.id === id)?.schedule?.assignedSession || 0;
