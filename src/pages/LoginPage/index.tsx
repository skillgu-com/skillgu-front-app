...
import Button, {ButtonTag} from '../../new-components/Button/Button';
import {Title, Text} from '../../new-components/typography/index';
// Types
import {TitleTag, TitleVariant} from '../../new-components/typography/Title/Title';
...
const LoginPage = () => {
	...
	return (
      ...
      <aside></aside>
			<section>
        <Title tag={TitleTag.h1} variant={TitleVariant.section}>Zaloguj się</Title>
				<form
	...
	// 				<div id='signInDiv'>Zaloguj sie</div>
	// 			</div>
