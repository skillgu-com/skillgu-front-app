...
export const MentorshipPlanForm = ({
    ...
    const {schedule} = createOfferState[subscriptionVariant];
    const selectedSchedule = useMemo(() => {
        const matchedValue = createOfferState.availableSchedules.find(({value}) => schedule.toString() === value.toString())
        ...
        >
          ...
          />
                ...
                sesje mentoringowe na miesiąc{" "}
                                {selectedSchedule
                                    ? `(każda po ${selectedSchedule} minut)`
                                    : ``}
              </span>
                        </div>
                    </div>
